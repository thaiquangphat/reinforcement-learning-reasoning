...
BEST_CHECKPOINT = {
    "hotpotqa": {
        "model": "checkpoints_baseline_ppo/baseline_rl_ppo_20251225_204539/model/baseline_rl_querypathrl_epoch2.pt",
        "rgat": "checkpoints_baseline_ppo/baseline_rl_ppo_20251225_204539/rgat/baseline_rl_rgat_epoch2.pt",
    },
    "2wikiqa": {
        "model": "checkpoints_baseline_ppo/baseline_rl_ppo_20251225_204611/model/baseline_rl_querypathrl_epoch10.pt",
        "rgat": "checkpoints_baseline_ppo/baseline_rl_ppo_20251225_204611/rgat/baseline_rl_rgat_epoch10.pt",
    },
    "musique": {
        "model": "checkpoints_baseline_ppo/baseline_rl_ppo_20251225_204716/model/baseline_rl_querypathrl_epoch2.pt",
        "rgat": "checkpoints_baseline_ppo/baseline_rl_ppo_20251225_204716/rgat/baseline_rl_rgat_epoch2.pt",
    },
}
...
def inference(
    ...
    tag: str = "hotpotqa",
    encoder: str = "bert",
    model_version: str = "QueryPathRLV02",
...
if __name__ == "__main__":
    ...
    inference(
        save_path="./inference_baseline_ppo",
        tag=args.dataset,
