...
BEST_CHECKPOINT = {
    "hotpotqa": {
        "model": "checkpoints_baseline_ac/baseline_rl_ac_20251223_204930/model/baseline_rl_querypathrl_epoch10.pt",
        "rgat": "checkpoints_baseline_ac/baseline_rl_ac_20251223_204930/rgat/baseline_rl_rgat_epoch10.pt",
    },
    "2wikiqa": {
        "model": "checkpoints_baseline_ac/baseline_rl_ac_20251224_082810/model/baseline_rl_querypathrl_epoch10.pt",
        "rgat": "checkpoints_baseline_ac/baseline_rl_ac_20251224_082810/rgat/baseline_rl_rgat_epoch10.pt",
    },
    "musique": {
        "model": "checkpoints_baseline_ac/baseline_rl_ac_20251223_205104/model/baseline_rl_querypathrl_epoch10.pt",
        "rgat": "checkpoints_baseline_ac/baseline_rl_ac_20251223_205104/rgat/baseline_rl_rgat_epoch10.pt",
    },
}
...
# --------------------------- Inference ---------------------------
def inference(
    save_path: str = "./inference_baseline_ac",
    dataset_path: str = "dataset/traintestamr.jsonl",
    tag: str = "hotpotqa",
    encoder: str = "bert",
    model_version: str = "QueryPathRLV01",
...
if __name__ == "__main__":
    ...
    inference(
        save_path="./inference_baseline_ac",
        tag=args.dataset,
