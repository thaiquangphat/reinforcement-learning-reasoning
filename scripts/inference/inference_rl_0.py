...
BEST_CHECKPOINT = {
    "hotpotqa": {
        "model": "checkpoints_baseline/baseline_rl_hotpotqa/model/baseline_rl_querypathrl_epoch10.pt",
        "rgat": "checkpoints_baseline/baseline_rl_hotpotqa/rgat/baseline_rl_rgat_epoch10.pt",
    },
    "2wikiqa": {
        "model": "checkpoints_baseline/baseline_rl_2wikiqa/model/baseline_rl_querypathrl_epoch10.pt",
        "rgat": "checkpoints_baseline/baseline_rl_2wikiqa/rgat/baseline_rl_rgat_epoch10.pt",
    },
    "musique": {
        "model": "checkpoints_baseline/baseline_rl_musique/model/baseline_rl_querypathrl_epoch10.pt",
        "rgat": "checkpoints_baseline/baseline_rl_musique/rgat/baseline_rl_rgat_epoch10.pt",
    },
}
...
# --------------------------- Inference ---------------------------
def inference(
    save_path: str = "./inference_baseline",
        ...
        try:
            ...
            for qury in batch["query"]:
                ...
                for _ in range(trials):
                    ...
                    if found and first_found_path is None and len(reasoning_path) > 1:
