...
if __name__ == "__main__":   
    parser = argparse.ArgumentParser(description="HotpotQA Dataset Creation")
    ...
    if args.type == 'triplets':
        if args.dataset == 'train':
             create_dataset_triplets("hotpotqa/hotpotqa_train.jsonl", 
                            "hotpotqa/hotpotqa_triplets_train.jsonl")
        elif args.dataset == 'test':
            create_dataset_triplets("hotpotqa/hotpotqa_validation.jsonl",
                            "hotpotqa/hotpotqa_triplets_validation.jsonl")
        ...
        if args.dataset == 'train':
            enrich_dataset_with_llm(llm, "dataset/hotpotqa/data/hotpotqa_triplets_train.jsonl", 
                            "dataset/hotpotqa/enrichment/hotpotqa_triplets_train_enrich.jsonl",
                            max_samples=18000)
        elif args.dataset == 'test':
            enrich_dataset_with_llm(llm, "dataset/hotpotqa/data/hotpotqa_triplets_validation.jsonl", 
                            "dataset/hotpotqa/enrichment/hotpotqa_triplets_eval_enrich.jsonl")
            
    elif args.type == 'clean':
        if args.dataset == 'train':
            clean_dataset("dataset/hotpotqa/enrichment/hotpotqa_triplets_train_enrich.jsonl", 
                            "dataset/hotpotqa/enrichment/hotpotqa_triplets_train_enrich_processed.jsonl")
        elif args.dataset == 'test':
            clean_dataset("dataset/hotpotqa/enrichment/hotpotqa_triplets_eval_enrich.jsonl",
                            "dataset/hotpotqa/enrichment/hotpotqa_triplets_eval_enrich_processed.jsonl")
            
    elif args.type == 'format':
        if args.dataset == 'train':
            format_dataset("dataset/hotpotqa/enrichment/hotpotqa_triplets_train_enrich_processed.jsonl", 
                            "dataset/hotpotqa/enrichment/hotpotqa_triplets_train_format.jsonl")
        elif args.dataset == 'test':
            format_dataset("dataset/hotpotqa/enrichment/hotpotqa_triplets_eval_enrich_processed.jsonl",
                            "dataset/hotpotqa/enrichment/hotpotqa_triplets_eval_format.jsonl")